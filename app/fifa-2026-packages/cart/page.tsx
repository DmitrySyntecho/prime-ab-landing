      ...
      <div className="relative min-h-screen">
        ...
        <div className="max-w-2xl mx-auto px-4 py-20 text-center">
          ...
          <p className="text-white/50 mb-8">
            Browse our LED wall rentals and add items to your cart to get started.
          </p>
          <Link
            ...
            <div key={key} className="flex items-center gap-4">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-full text-[13px] font-bold transition-all ${
                  step === key
                    ? "text-white"
                    : ["details", "payment"].indexOf(step) > ["cart", "details", "payment"].indexOf(key)
                    ? "text-[#5BC25A]"
                    : "text-white/40"
                }`}
                style={{
                ...
                {items.map((item) => (
                  ...
                  >
                    <div className="flex gap-4">
                      <Link
                        href={`/fifa-2026-packages/products/${item.product.slug}`}
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <input
                        ...
                        onChange={handleInputChange}
                        className="px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white focus:border-[#5BC25A] focus:outline-none transition-colors ios-picker"
                        required
                      />
                      <input
                        type="time"
                      ...
                      <div key={item.product.id} className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-[12px] text-white/50">
                            {item.quantity} x {item.rentalDays} days
                          </div>
                        </div>
