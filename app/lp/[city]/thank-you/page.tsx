    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative flex-1 py-14 md:py-24">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <div
            className="w-20 h-20 rounded-full bg-[#FF2D6F]/15 border border-[#FF2D6F]/30 flex items-center justify-center mx-auto mb-7"
            style={{ boxShadow: "0 0 40px rgba(255,45,111,0.35)" }}
          >
            <CheckCircle2 className="w-10 h-10 text-[#FF2D6F]" strokeWidth={2} />
          </div>

          <h1 className="text-[32px] md:text-[48px] font-extrabold tracking-[-0.03em] leading-[1.06] text-white mb-4">
              ...
              {steps.map(({ icon: Icon, text }, i) => (
                <li key={text} className="flex items-start gap-4">
                  <span className="relative w-9 h-9 rounded-[10px] bg-[#FF2D6F]/14 border border-[#FF2D6F]/24 grid place-items-center text-[#FF2D6F] flex-shrink-0">
                    ...
                    <span className="absolute -top-1.5 -left-1.5 w-5 h-5 rounded-full bg-[#FF2D6F] text-white text-[11px] font-bold grid place-items-center">
                      {i + 1}
                    </span>
                  </span>
          ...
          {/* Speed-up: WhatsApp */}
          <div
            className="mt-6 rounded-[20px] border border-[#25D366]/25 p-6 md:p-8"
            style={{ background: "linear-gradient(135deg, rgba(37,211,102,0.10) 0%, rgba(37,211,102,0.02) 100%)" }}
          >
            <p className="text-white/85 text-[15px] md:text-[16px] leading-relaxed max-w-xl mx-auto mb-5">
              Send us photos or videos of your venue on WhatsApp right now. It helps our designers build your 3D
              render faster.
            </p>
            <a
              href={waHref}
              ...
              style={{
                background: "#25D366",
                color: "#03251a",
                boxShadow: "0 12px 36px -8px rgba(37,211,102,0.6)",
              }}
            >
          ...
          <a
            href={`/lp/${data.slug}`}
            className="mt-8 inline-flex items-center gap-2 text-white/55 text-[13px] hover:text-white transition-colors"
          >
