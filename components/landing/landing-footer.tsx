      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-6">
          <div className="flex flex-col items-center md:items-start gap-3">
            <Image src="/images/prime-line-av-logo-dark-bg.svg" alt="Prime Line AV" width={190} height={34} className="h-8 w-auto" />
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <a href={`tel:${LANDING_PHONE_TEL}`} className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white/[0.05] border border-white/[0.12] text-white font-semibold text-[13px] hover:bg-white/[0.10] transition-all">
        ...
        <div className="mt-8 pt-6 border-t border-white/[0.06] flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-white/40 text-[12px]">© 2026 Prime Line AV. All rights reserved.</p>
          <div className="flex items-center gap-5">
            <a href="/legal/privacy" className="text-white/45 text-[12px] hover:text-white/75 transition-colors">Privacy Policy</a>
            <a href="/legal/terms" className="text-white/45 text-[12px] hover:text-white/75 transition-colors">Terms &amp; Conditions</a>
          </div>
        </div>
      </div>
    </footer>
